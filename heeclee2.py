...
class PensionData():
    ...
    def preprocess(self):
        ...
        df = self.df.drop(
            ['자료생성년월', '우편번호', '사업장지번상세주소', '고객법정동주소코드', '고객행정동주소코드', '사업장형태구분코드 1 법인 2 개인', '적용일자', '재등록일자'], axis=1)
...
def read_pensiondata():
    data = PensionData('C:/Users/68103/PycharmProjects/pythonProject/pension.csv')
    return data
